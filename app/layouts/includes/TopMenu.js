    ...
    const isLoggedIn = () => {
        if (user && user?.id) {
            return (
                ...
                >
                    <div>Hi, {user?.name ? user.name.substring(0, 5) : ''}.</div>
                    <BsChevronDown/>
                </button>
            )
        } 
    ...
    return (
        <>
            <div id="TopMenu" className="border-b">
                <div className="flex items-center justify-between md:justify-between lg:justify-between w-full mx-auto max-w-[100%] lg:max-w-[1200px] md-max-w-[1200px]">
                    <ul 
                        id="TopMenuLeft"
                        className="flex items-center text-[11px] text-[#333333] px-2 h-8"
                    >
                        <li className="relative px-3 block md:hidden lg:hidden mt-2">
                            <Link href="/">
                                <img src="/images/logo.svg" className="w-[60px] h-[40px]" />
                            </Link>
                        </li>
                        ...
                        <li className="px-3 hover:underline cursor-pointer hidden md:block lg:block">
                            Daily Deals
                        </li>
                        <li className="px-3 hover:underline cursor-pointer hidden md:block lg:block">
                            Help & Contact
                    ...
                    >
                        ...
                        >
                           ...
                           <font className="hidden md:block lg:block">Ship to</font>
                        </li>
                        <ClientOnly>
