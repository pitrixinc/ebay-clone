            ...
            <div id="CheckoutPage" className="mt-4 max-w-[1100px] mx-auto">
                ...
                <div className="relative flex items-baseline gap-4 justify-between mx-auto w-full">
                    <div className="w-[100%] md:w-[65%] lg:w-[65%]">
                        ...
                        <ClientOnly>
                            <div id="Items" className="bg-white rounded-lg mt-4 w-[70%] md:-w-full lg:w-full hidden md:block lg:block">
                    ...
                    <div id="PlaceOrder" className="relative -top-[6px] w-[35%] border rounded-lg hidden md:block lg:block">
                        <ClientOnly>
                            <div className="p-4">
                ...
                <ClientOnly>
                            <div id="Items" className="bg-white rounded-lg mt-4 w-[100%] block md:hidden lg:hidden">
                                {cart.getCart().map(product => (
                                    <CheckoutItem key={product.id} product={product} />
                                ))}
                            </div>
                ...
                <div id="PlaceOrder" className="relative -top-[6px] w-full border rounded-lg block md:hidden lg:hidden">
                        <ClientOnly>
                            <div className="p-4">
                                <div className="flex items-baseline justify-between text-sm mb-1">
                                    <div>Items ({cart.getCart().length})</div>
